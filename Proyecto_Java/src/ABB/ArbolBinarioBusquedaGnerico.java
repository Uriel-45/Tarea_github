...
public class ArbolBinarioBusquedaGnerico<V extends Comparable<V>> {
	 
    Nodo_generico<V> raiz = null;
    private int numeroElementos = 0;
    private int numeroBusquedas = 0;
    private int numeroIteracionesTotal = 0;
    private int numeroIteracionesUltimaBusqueda = 0;
 
    public ArbolBinarioBusquedaGnerico() {
 
    }
 
    public void insertarElemento(V value) {
        Nodo_generico<V> nuevoNodo = new Nodo_generico<V>(value, null, null);
    ...
    public V buscarElemento(V value) {
        Nodo_generico<V> aux = raiz;
        Nodo_generico<V> resultado = null;
    ...
    public boolean eliminarElemento(V value) {
        ...
        while (aux != null) {
            ...
            if (aux.getValue().compare(value) == 0) {
                Nodo_generico<V> nodoAEliminar = aux;
                ...
                Nodo_generico<V> nodoAEliminar = aux.getIzq();
                ...
                Nodo_generico<V> nodoAEliminar = aux.getDer();
    ...
    private void insertarNodo(Nodo_generico<V> nodo) {
        if (raiz == null) {
            raiz = nodo;
            System.out.println("Inserto la raiz");
        } else {
    ...
    private void recorrerAscendente(Nodo_generico<V> nodo, ArrayList<V> elementos) {
        if (nodo != null) {
    ...
    private void recorrerDescendente(Nodo_generico<V> nodo, ArrayList<V> elementos) {
        if (nodo != null) {
            if (nodo.getIzq() == null && nodo.getDer() == null) {
                elementos.add(nodo.getValue());
            } else {
