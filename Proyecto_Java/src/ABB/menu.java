...
public class menu {
	...
	public static void main(String[] args) {
	    ...
	    ArbolBinarioBusquedaGnerico<Producto> abb = new ArbolBinarioBusquedaGnerico<Producto>();
	 ...
	 // Imprimimos el número de elementos que tenemos:
	    ...
	    System.out.print("\nLista de números ordenados descendentemente: { ");
	    ...
	    System.out.println("\nNumero de iteraciones en la última búsqueda: " + abb.getNumeroIteracionesUltimaBusqueda());
	    System.out
	            .println("\nNumero de iteraciones medio en las búsquedas: " + abb.getNumeroIteracionesMedioEnBusquedas());
